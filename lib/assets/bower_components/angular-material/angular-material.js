 ...
 *
 */
function SidenavController($rootScope, $scope, $element, $attrs, $mdComponentRegistry, $q) {
  ...
  self.close  = function() { 
    //Add event on sidenav close
    $rootScope.$broadcast('sidenav:' + self.$$mdHandle + ':closed');
...
SidenavController.$inject = ["$rootScope", "$scope", "$element", "$attrs", "$mdComponentRegistry", "$q"];
